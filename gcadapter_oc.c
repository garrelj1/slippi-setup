...
#define GCADAPTER_VID 0x1a34
#define GCADAPTER_PID 0xf705

MODULE_LICENSE("GPL");
MODULE_AUTHOR("Hannes Mann");
MODULE_DESCRIPTION("Filter kernel module to set the polling rate of the ACRUX USB GamePad to a custom value.");
MODULE_VERSION("1.4");
